...
namespace Farris.API.Client.Template
{
    ...
    public partial interface IClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task GetPizzaImageAsync(int pizzaId);

        /// <exception cref="ApiException">A server side error occurred.</exception>
        void GetPizzaImage(int pizzaId);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task GetPizzaImageAsync(int pizzaId, System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task GetPizzaImageAsync(int pizzaId)
        {
            return GetPizzaImageAsync(pizzaId, System.Threading.CancellationToken.None);
        }

        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual void GetPizzaImage(int pizzaId)
        {
            System.Threading.Tasks.Task.Run(async () => await GetPizzaImageAsync(pizzaId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task GetPizzaImageAsync(int pizzaId, System.Threading.CancellationToken cancellationToken)
        {
            if (pizzaId == null)
        ...
        public virtual async System.Threading.Tasks.Task<ResultOfIEnumerableOfPizzaModel> Search_for_pizzasAsync(GetAllPizzasQuery query, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/pizzas/Search"
                    urlBuilder_.Append("v1/pizzas/Search");
        ...
        {
            return System.Threading.Tasks.Task.Run(async () => await Complete_orderAsync(command, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        public virtual async System.Threading.Tasks.Task<ResultOfOrderModel> Complete_orderAsync(CompleteOrderCommand command, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/pizzasorder/complete"
                    urlBuilder_.Append("v1/pizzasorder/complete");
        ...
        {
            return System.Threading.Tasks.Task.Run(async () => await Create_orderAsync(command, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        public virtual async System.Threading.Tasks.Task<ResultOfOrderModel> Create_orderAsync(CreateOrderCommand command, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/pizzasorder"
                    urlBuilder_.Append("v1/pizzasorder");
        ...
        {
            return System.Threading.Tasks.Task.Run(async () => await Get_order_statusAsync(id, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        public virtual async System.Threading.Tasks.Task<ResultOfOrderStatus> Get_order_statusAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v1/pizzasorder/status/{id}"
                    urlBuilder_.Append("v1/pizzasorder/status/");
    ...
    public partial class OrderModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("PizzaId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.2.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class CompleteOrderCommand
    {
