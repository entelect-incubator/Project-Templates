...
public class OrderTests : QueryTestBase
{
    ...
    [TestCase(OrderStatus.Making)]
    [TestCase(OrderStatus.Complete)]
    [TestCase(OrderStatus.SentOutForDelivery)]
    public void OrderTestDataMother_CreateWithStatus_GeneratesOrderWithCorrectStatus(OrderStatus expectedStatus)
    {
    ...
    public void OrderTestDataMother_CreateConfirmedOrders_GeneratesOrdersInConfirmedStatus()
    {
        ...
        Assert.That(orders, Has.All.Property("Status").EqualTo(OrderStatus.Confirmed));
    }
    ...
    public void OrderTestDataMother_CreateCompleteOrders_GeneratesOrdersInCompleteStatus()
    {
        ...
        Assert.That(orders, Has.Count.EqualTo(10));
        Assert.That(orders, Has.All.Property("Status").EqualTo(OrderStatus.Complete));
    }
